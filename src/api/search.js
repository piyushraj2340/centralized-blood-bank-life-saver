...
router.route('/blood-bank').post(async (req, res) => {
    try {
...
router.route('/blood-bank/:id').post(async (req, res) => {
    try {
        // // request for the secrete token jwt and verify the authentication 
        // const token = req.headers.token;
...
router.route('/blood-camp').post(async (req, res) => {
    try {
        // // request for the secrete token jwt and verify the authentication 
        // const token = req.headers.token;
...
router.route('/bloods').post(async (req, res) => {
    try {
        // // request for the secrete token jwt and verify the authentication 
        // const token = req.headers.token;
